...
\newcommand{\data}{5 Febbraio 2025}
...
\newcommand{\destinatari }{
    ...
    & Tullio Vardanega  \\
    & Riccardo Cardin  }
\newcommand{\abstractcontent}{A seguito del periodo di esami, in parte, trascorso abbiamo svolto una riunione insieme a Vimar S.p.A con l'obiettivo di aggiornare lo stato attuale del progetto e capire i passi futuri.}
