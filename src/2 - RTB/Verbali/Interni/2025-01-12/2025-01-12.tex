...
\newcommand{\data}{12 gennaio 2025}
...
\newcommand{\destinatari }{
   %& Vimar S.p.A.  \\
    & Tullio Vardanega  \\
    & Riccardo Cardin  }
\newcommand{\abstractcontent}{Riunione eseguita in preparazione dei prossimi eventi: presentazione di un applicativo di prova all'azienda e RTB.}
