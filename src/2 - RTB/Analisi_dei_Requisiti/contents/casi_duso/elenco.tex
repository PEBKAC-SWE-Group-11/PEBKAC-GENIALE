...
\subuc{Visualizzazione conversazione libera\textsubscript{G}}{visual_conv_libera}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subuc{Visualizzazione conversazione guidata\textsubscript{G}}{visual_conv_guidata}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subsubsubsubuc{Visualizzazione link\textsubscript{G} di riferimento alle fonti}{visual_rif}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subsubsubsubsubuc{Visualizzazione link\textsubscript{G} per download fonte in PDF}{visual_rif_down}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subsubsubsubuc{Visualizzazione pulsante feedback\textsubscript{G} positivo}{visual_feedback_pos}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subsubsubsubuc{Visualizzazione pulsante feedback\textsubscript{G} negativo}{visual_feedback_pos}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subuc{Fornitura di feedback\textsubscript{G} negativo sulla risposta del \textit{sistema}\textsubscript{G} ad interrogazione}{feedback_negativo}
\begin{itemize}
    \item \textbf{Attori coinvolti}: Installatore;
...
\subuc{Visualizzazione numero risposte positive dal sistema\textsubscript{G} di feedback\textsubscript{G}}{visualizzazione_risposte_positive}
\begin{itemize}
    \item \textbf{Attori coinvolti}: \textit{Amministratore}\textsubscript{G};
...
\subuc{Visualizzazione numero risposte negative dal sistema\textsubscript{G} di feedback\textsubscript{G}}{visualizzazione_risposte_negative}
\begin{itemize}
    \item \textbf{Attori coinvolti}: \textit{Amministratore}\textsubscript{G};
