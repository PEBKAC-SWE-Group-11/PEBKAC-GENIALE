...
\begin{itemize}
    ...
    %\item \textbf{Bug reporting}: Processo di registrazione e monitoraggio dei \textit{bug}\textsubscript{G} o errori rilevati durante i \textit{test}\textsubscript{G} \textit{software}\textsubscript{G}, con lo scopo di risolverli.
\end{itemize}
