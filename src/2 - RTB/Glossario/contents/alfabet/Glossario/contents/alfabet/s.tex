...
\begin{itemize}
    ...
    %\item \textbf{Scrum}: \textit{Framework}\textsubscript{G} di \textit{Agile}\textsubscript{G} per gestire progetti complessi, basato su iterazioni e \textit{feedback}\textsubscript{G} continui.
     %\item \textbf{SEMAT}: \textit{Sistema}\textsubscript{G} a sei livelli per misurare il progresso di un progetto\textsubscript{G}.
