...
\begin{itemize}
    ...
    %\item \textbf{End-to-end test}: Metodo di \textit{test}\textsubscript{G} che verifica il funzionamento completo di un'applicazione simulando scenari realistici dal punto di vista dell'utente.
