...
\usepackage[unicode, colorlinks=true, linkcolor=black, urlcolor=blue, citecolor=green]{hyperref}
...
\newpage
\input{contents/analisi_dei_rischi}
\newpage
\input{contents/modello_di_sviluppo}
\newpage
