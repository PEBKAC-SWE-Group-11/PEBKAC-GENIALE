...
\resizebox{1.0\textwidth}{!}{%
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
         \textbf{} & \textbf{Re.} &  \textbf{Am.} &  \textbf{Ve.} &  \textbf{An.} & \textbf{Pg.} &  \textbf{Pr.} & \textbf{Totale per persona}\\
         \hline \colorrow
           \cellcolor{lightgray}{\textbf{Benin}} & 0 & 0 & 0 & 0 & 0 & 7 & 7\\
        \hline
           \textbf{Bourosu} & 0 & 0 & 0 & 0 & 5 & 0 & 5\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Gerardin}} & 0 & 0 & 0 & 4 & 0 & 0 & 4\\
        \hline 
           \textbf{Gusatto} & 8 & 0 & 0 & 0 & 0 & 0 & 8\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Martinelli}} & 0 & 4 & 0 & 0 & 0 & 0 & 4\\
        \hline 
           \textbf{Piron} & 0 & 0 & 8 & 0 & 0 & 0 & 8\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Zocche}} & 0 & 0 & 8 & 0 & 0 & 0 & 8\\
        \hline 
           \textbf{Totale per ruolo} & 8 & 4 & 16 & 4 & 5 & 7 & 44\\
        \hline
    \end{tabular}
}
...
\resizebox{1.0\textwidth}{!}{%
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
         \textbf{} & \textbf{Re.} &  \textbf{Am.} &  \textbf{Ve.} &  \textbf{An.} & \textbf{Pg.} &  \textbf{Pr.} & \textbf{Totale per persona}\\
         \hline \colorrow
           \cellcolor{lightgray}{\textbf{Benin}} & 0 & 0 & 2 &0 & 0 & 4 & 6\\
        \hline
           \textbf{Bourosu} & 0 & 0 & 3 & 0 & 5 & 4 & 12\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Gerardin}} & 0 & 0 & 2 & 4 & 0 & 0 &6\\
        \hline 
           \textbf{Gusatto} & 7 & 0 & 0 & 0 & 0 & 0 & 7\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Martinelli}} & 0 & 4 & 0 & 0 & 0 & 0 & 4\\
        \hline 
           \textbf{Piron} & 0 & 0 & 3 & 0 & 0 & 0 & 3\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Zocche}} & 0 & 0 & 5 & 0 & 0 & 0 & 5\\
        \hline 
...
\resizebox{1.0\textwidth}{!}{%
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
         \textbf{} & \textbf{Re.} &  \textbf{Am.} &  \textbf{Ve.} &  \textbf{An.} & \textbf{Pg.} &  \textbf{Pr.} & \textbf{Totale per persona}\\
         \hline \colorrow
           \cellcolor{lightgray}{\textbf{Benin}} & 4 & 7 & 6 & 2 & 9 & 18 & 46\\
        \hline
           \textbf{Bourosu} & 7 & 8 & 21 & 0 & 7 & 5 & 48\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Gerardin}} & 3 & 2 & 3 & 0 & 18 & 21 & 47\\
        \hline 
           \textbf{Gusatto} & 2 & 2 & 21 & 3 & 7 & 7 & 42\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Martinelli}} & 4 & 4 & 5 & 1 & 18 & 24 & 56\\
        \hline 
           \textbf{Piron} & 10 & 0 & 21 & 4 & 4 & 4 & 43\\
        \hline \colorrow
           \cellcolor{lightgray}{\textbf{Zocche}} & 3 & 3 & 9 & 3 & 18 & 13 & 45\\
        \hline 
           \textbf{Totale per ruolo} & 33 & 26 & 86 & 13 & 81 & 88 & 327\\
        \hline\colorrow
           \cellcolor{lightgray}{\textbf{Totale}} & 990€ & 520€ & 1290€ & 325€ & 2025€ & 1320€ & 6470€\\
        \hline
    \end{tabular}
}
...
\paragraph{Preventivo} \hspace{1cm} 
\\ \hspace{1cm} \\
\todo[inline]{Completare questa sezione!}
Ruoli coinvolti: Responsabile, Amministratore, Verificatore, Analista, Progettista.
\begin{table}[H]
\centering
\resizebox{1.0\textwidth}{!}{%
...
%--------------------------------------------------------------------------------------------%
%                                                                                            %
%       TEMPLATE PERIODO VUOTO DA COPIARE                                                    %
%                                                                                            %
%--------------------------------------------------------------------------------------------%
%--------------------------------------------------------------------------------------------%
...
\caption{Preventivo dell'impegno orario di ciascun membro durante il periodo INS}
\end{table}
...
\caption{Consuntivo dell'impegno orario di ciascun membro durante il periodo INS}
\end{table}
...
\caption{Preventivo a finire dopo la retrospettiva sul periodo INS}
\end{table}