...
\newcommand{\data}{27 marzo 2025}
\newcommand{\titolo}{Verbale Esterno}
\newcommand{\responsabile}{Matteo Piron}
...
\newcommand{\destinatari }{
    ...
    & Tullio Vardanega  \\
    & Riccardo Cardin  }
\newcommand{\abstractcontent}{Quinto SAL con cadenza settimanale della durata di 60 minuti. Nella riunione si è discusso in particolare di testing del codice e di qualità della risposta del modello LLM, come anticipato qualche giorno prima tramite email.}
