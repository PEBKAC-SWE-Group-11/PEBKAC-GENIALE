...
\newcommand{\data}{24 febbario 2025}
...
\newcommand{\destinatari }{
   %& Vimar S.p.A.  \\
    & Tullio Vardanega  \\
    & Riccardo Cardin  }
\newcommand{\abstractcontent}{Aggiornamento periodico per l'aggiornamento del gruppo sugli avanzamenti e l'organizzazione del lavoro. Aggiornamenti per il SAL con il Proponente.}
