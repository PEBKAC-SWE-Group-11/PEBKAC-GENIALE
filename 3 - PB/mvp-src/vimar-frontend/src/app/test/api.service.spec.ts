...
describe('api.service', () => {   
    ...
    describe('api.service', () => {
        ...
        it('should get feedback`s comment', async() => {
            ...
            const req = httpMock.expectOne(`${apiUrl}/api/dashboard/feedback_comments`);
            expect(req.request.method).toBe('GET');
        ...
        it('should get admin stats', async() => {
            ...
            const conversationRequest = httpMock.expectOne(`${apiUrl}/api/dashboard/num_conversations`);
            const positiveFeedbacksRequest = httpMock.expectOne(`${apiUrl}/api/dashboard/num_positive`);
            const negativeFeedbacksRequest = httpMock.expectOne(`${apiUrl}/api/dashboard/num_negative`);
