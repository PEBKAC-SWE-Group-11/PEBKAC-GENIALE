...
class TestChunkElabotation(unittest.TestCase):
    ...
    def test_downloadPdf(self, mock_open_file, mock_requests_get):
        ...
        result = downloadPdf('https://www.vimar.com/irj/go/km/docs/z_catalogo/DOCUMENT/ZIS_49401771A0_FI.100294.pdf', 'sample.pdf')
    ...
    def test_processPdf(self, mock_pdfToTxt, mock_downloadPdf, mock_print, mock_basename, mock_join):
        # Chiama la funzione processPdf
        result = processPdf('https://www.vimar.com/irj/go/km/docs/z_catalogo/DOCUMENT/ZIS_49401771A0_FI.100294.pdf')

        # Verifica che il risultato sia il percorso del file di testo generato
        self.assertEqual(result, 'txts/sample.txt')

        # Verifica che downloadPdf sia stato chiamato con i parametri corretti
        mock_downloadPdf.assert_called_once_with('https://www.vimar.com/irj/go/km/docs/z_catalogo/DOCUMENT/ZIS_49401771A0_FI.100294.pdf', 'pdfs/sample.pdf')

        # Verifica che pdfToTxt sia stato chiamato con i parametri corretti
