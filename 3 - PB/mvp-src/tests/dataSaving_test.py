...
#     @patch('..data_processing.dataSaving.productsElaboration.removeTranslations', return_value=[{'product_id': '1', 'title': 'title1', 'description': 'desc1', 'etim': 'etim1'}])
#     @patch('..data_processing.dataSaving.productsElaboration.extractLinks', return_value={'1': {'link': 'http://example.com/doc1.pdf', 'ids': ['1']}})
#     @patch('..data_processing.dataSaving.productsElaboration.processProducts', return_value=[{'product_id': '1', 'title': 'title1', 'description': 'desc1', 'etim': 'etim1', 'id_vector': [0.1, 0.2, 0.3], 'idtitle_vector': [0.1, 0.2, 0.3], 'idtitledescr_vector': [0.1, 0.2, 0.3]}])
